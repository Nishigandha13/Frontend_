...
useEffect(() => {
  ...
  async function  Load()
  {
     const result = await axios.get(
         "https://three-tier-architecture-project.onrender.com/api/v1/student/getall");
    ...
    try
        {
         await axios.post("https://three-tier-architecture-project.onrender.com/api/v1/student/save",
        {
   ...
   {
        await axios.delete("https://three-tier-architecture-project.onrender.com/api/v1/student/delete/" + studentid); 
   ...
   try
       {
        await axios.put("https://three-tier-architecture-project.onrender.com/api/v1/student/edit/" + studentid ,
       {
  ...
  return (
    <div>
      <h2 align="center">NISHIGANDHA EKAPURE CA2 PROJECT</h2>
      <h3 align="center">PRN No. 2146491245113</h3>
